...
# ═════════════════════════════════════════════════════════════════════════════
# RISK LEVEL - مع إضافة CRITICAL
# ═════════════════════════════════════════════════════════════════════════════

def risk_level(score: float, score_min: float, score_max: float) -> str:
    """
    تصنيف مستوى الخطر مع إضافة مستوى CRITICAL
    
    مستويات الخطر:
    - CRITICAL: أقل من 10% من النطاق
    - HIGH: 10% - 25%
    - MEDIUM: 25% - 50%
    - LOW: أكثر من 50%
    """
...
def get_mission_status(risk_counts):
    """
    تقييم حالة المهمة بناءً على عدد الأحداث حسب مستوى الخطورة
    """
...
def render_mission_status(risk_counts, n_anomalies=0):
    """
    عرض حالة المهمة في واجهة المستخدم
    """
...
# ═════════════════════════════════════════════════════════════════════════════
# ALERT BANNER - مع دعم CRITICAL
# ═════════════════════════════════════════════════════════════════════════════

def render_alert_banner(n_anomalies, risk_counts):
    """
    عرض تنبيهات مع دعم مستوى CRITICAL
    """
...
# ═════════════════════════════════════════════════════════════════════════════
# KPI ROW - مع دعم CRITICAL
# ═════════════════════════════════════════════════════════════════════════════

def render_kpi_row(preds, scores, risk_counts):
    """
    عرض مؤشرات الأداء مع دعم CRITICAL
    """
    n_total = len(preds)
...
if IS_REAL:
    ...
    render_mission_status(risk_counts, n_anomalies)  # إضافة حالة المهمة
